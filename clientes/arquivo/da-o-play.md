...
1. **Wireframe da landing page + copy**
2. **Identidade visual**: logo, paleta de cores, tipografia
   - Logo: liberdade criativa total, cliente não tem nada definido
   - Paleta: já usam roxo + modo escuro no protótipo, abertos a refinar mas seguir essa linha

## Prazos

- Orçamento: o quanto antes
- Entrega final: flexível — o software do cliente ainda está em desenvolvimento

## Status

Em orçamento — ainda não iniciado.
